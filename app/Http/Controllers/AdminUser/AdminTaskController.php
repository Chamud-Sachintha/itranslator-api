...
class AdminTaskController extends Controller
{
            ...
            try {
                ...
                if ($adminInfo) {
                    ...
                    foreach ($resp as $key => $value) {
                        ...
                        $dataList[$key]['createTime'] = $date;
                        $timestamp = $orderAssign['create_time'];
                        $Ssigndate = date('Y-m-d H:i:s', $timestamp);
                        $dataList[$key]['assignedTime'] =  $Ssigndate;
                    }
    ...
    public function getCompleteNotaryTaskList(Request $request) {
